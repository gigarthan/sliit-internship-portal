    ...
    return (
      <div className="App">
        ...
        {this.state.interns.map(intern => (
          <Intern key={intern.id} name={intern.name} email={intern.email} supervisor={(Object.keys(intern.supervisor).length === 0 && intern.supervisor.constructor === Object) ? this.state.supervisors : intern.supervisor} />

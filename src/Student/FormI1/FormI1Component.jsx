...
import { submitI1Form } from "../../store/actions/student_actions";
import { connect } from 'react-redux';
class FormI1 extends Component {
  submit = values => {
    this.props.submitI1Form(this.props.location.state.index, values, this.props.history);
  };
          ...
          <Container fluid>
            ...
            <Form onSubmit={handleSubmit(this.submit)} >
              ...
              <Form.Field>
                ...
                <Field
                  name="address"
                  placeholder="11/15, St.Mary's Road, Mount Lavinia"
                  component="input"
                  type="text"
                />
              </Form.Field>
...
const withRouterComp = withRouter(FormI1);
